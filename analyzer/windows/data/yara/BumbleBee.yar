...
rule Bumblebee
{
    meta:
        ...
        cape_options = "bp0=$antivm1+2,bp1=$antivm2+2,bp1=$antivm3+38,bp1=$antivm4+42,action0=jmp,action1=skip,count=0,force-sleepskip=1"
    strings:
        ...
        $antivm4 = {33 C9 E8 [4] 48 8B C8 E8 [4] 83 CA FF 48 8B 0D [4] FF 15 [4] 48 83 CF FF 4C}
    condition:
