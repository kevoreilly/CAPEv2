rule GetTickCountAntiVM
{
    meta:
        ...
        cape_options = "bp0=$antivm1-13,bp0=$antivm5-40,action0=wret,hc0=1,bp1=$antivm2-6,action1=wret,hc1=1,count=1,bp2=$antivm3+42,action2=jmp:96,bp3=$antivm4-9,action3=wret,hc3=1"
