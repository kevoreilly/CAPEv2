...
import logging
import threading
from ctypes import byref, c_uint, sizeof, addressof, create_string_buffer

from lib.common.defines import (ADVAPI32, KERNEL32, PIPE_WAIT, PIPE_TYPE_BYTE, ERROR_MORE_DATA, ERROR_BROKEN_PIPE,
                                PIPE_TYPE_MESSAGE, PIPE_ACCESS_DUPLEX, PIPE_READMODE_BYTE, PIPE_ACCESS_INBOUND, SECURITY_ATTRIBUTES,
                                SECURITY_DESCRIPTOR, ERROR_PIPE_CONNECTED, INVALID_HANDLE_VALUE, PIPE_READMODE_MESSAGE,
