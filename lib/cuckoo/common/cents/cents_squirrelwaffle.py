...
def cents_squirrelwaffle(config_dict, sid_counter, md5, date, task_link):
    ...
    for urls in url_list_main:
        ...
        for nested_url in urls:
            ...
            http_rule = (
                f'alert http $HOME_NET any -> $EXTERNAL_NET any (msg:"ET CENTS SquirrelWaffle CnC '
            ...
            dns_rule = (
                f'alert dns $HOME_NET any -> any any (msg:"ET CENTS SquirrelWaffle CnC Domain in DNS Query";'
