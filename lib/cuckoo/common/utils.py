...
def get_files_storage_path(sha256: str) -> str:
    ...
    If the file exists in the flat legacy path (storage/files/abcdef...),
    returns that path for backward compatibility.
    """
    flat_path = os.path.join(CUCKOO_ROOT, "storage", "files", sha256)
