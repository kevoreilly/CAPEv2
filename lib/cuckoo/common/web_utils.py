...
search_term_map = {
    ...
    "yaraname": ("info.parent_sample.yara.name", "target.file.yara.name", "dropped.yara.name", "procdump.yara.name", "CAPE.payloads.yara.name"),
    "capeyara": ("info.parent_sample.cape_yara.name", "target.file.cape_yara.name", "dropped.cape_yara.name", "procdump.cape_yara.name", "CAPE.payloads.cape_yara.name"),
    "capetype": ("info.parent_sample.cape_yara.cape_type", "target.file.cape_yara.cape_type", "dropped.cape_yara.cape_type", "procdump.cape_yara.cape_type", "CAPE.payloads.cape_yara.cape_type"),
