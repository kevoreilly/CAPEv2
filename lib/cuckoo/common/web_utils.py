...
search_term_map = {
    ...
    "string": "strings",
    "ssdeep": ("info.parent.ssdeep", "target.file.ssdeep", "dropped.ssdeep", "procdump.ssdeep", "CAPE.payloads.ssdeep"),
    "trid": "trid",
    "crc32": ("info.parent.crc32", "target.file.crc32", "dropped.crc32", "procdump.crc32", "CAPE.payloads.crc32"),
    ...
    "md5": ("info.parent.md5", "target.file.md5", "dropped.md5", "procdump.md5", "CAPE.payloads.md5"),
    "sha1": ("info.parent.sha1", "target.file.sha1", "dropped.sha1", "procdump.sha1", "CAPE.payloads.sha1"),
    "sha3": ("info.parent.sha3", "target.file.sha3_384", "dropped.sha3_384", "procdump.sha3_384", "CAPE.payloads.sha3_384"),
    "sha256": ("info.parent.sha256", "target.file.sha256", "dropped.sha256", "procdump.sha256", "CAPE.payloads.sha256"),
    "sha512": ("info.parent.sha512", "target.file.sha512", "dropped.sha512", "procdump.sha512", "CAPE.payloads.sha512"),
    "tlp": "info.tlp",
