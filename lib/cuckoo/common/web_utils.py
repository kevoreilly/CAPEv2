...
search_term_map = {
    ...
    "capetype": (
        "info.parent_sample.cape_yara.cape_type",
        "target.file.cape_yara.cape_type",
        "dropped.cape_yara.cape_type",
        "procdump.cape_yara.cape_type",
        "CAPE.payloads.cape_yara.cape_type",
    ),
