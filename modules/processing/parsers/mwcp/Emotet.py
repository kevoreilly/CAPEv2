                                        ...
                                        if refc2list:
                                            ...
                                            if refc2list:
                                                ...
                                                if refc2list:
                                                    ...
                                                    refc2list = yara_scan(filebuf, "$snippetI")
                                                    if refc2list:
                                                        delta = -4
                                                        c2list_va_offset = int(refc2list["$snippetI"])
                                if c2list_va_offset:
                                    ...
                                    size = (
                                        struct.unpack("I", filebuf[c2_list_offset + 4 : c2_list_offset + 8])[0]
                        ...
                        if ref_ecc:
                            ...
                            if ref_ecc:
                                ...
                                if ref_ecc:
                                    ...
                                    ref_ecc = yara_scan(filebuf, "$ref_ecc6")
                                    if ref_ecc:
                                        ref_ecc_offset = int(ref_ecc["$ref_ecc6"])
                                        delta1 = -4
                                        delta2 = 48
                if ref_ecc_offset:
