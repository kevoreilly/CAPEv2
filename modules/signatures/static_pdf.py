    ...
    def run(self):
        ...
        if "static" in self.results and "pdf" in self.results["static"]:
            if "PDF" in self.results.get("target", {})["file"].get("type", ""):
                ...
                if "Keywords" in self.results["static"]["pdf"]:
                    if (
                        "/JavaScript" in self.results["static"]["pdf"]["Keywords"]
                        or "/JS" in self.results["static"]["pdf"]["Keywords"]
                    ):
                        if (
                            self.results["static"]["pdf"]["Keywords"]["/JavaScript"] > 0
                ...
                if "Keywords" in self.results["static"]["pdf"]:
                    if (
                        "/OpenAction" in self.results["static"]["pdf"]["Keywords"]
                        or "/AA" in self.results["static"]["pdf"]["Keywords"]
                    ):
                        if (
                            self.results["static"]["pdf"]["Keywords"]["/OpenAction"] > 0
                            or self.results["static"]["pdf"]["Keywords"]["/AA"] > 0
                        ):
