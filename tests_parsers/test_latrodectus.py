...
with suppress(ImportError):
    from modules.processing.parsers.MACO.Latrodectus import convert_to_MACO
    ...
    with open("tests/data/malware/a547cff9991a713535e5c128a0711ca68acf9298cc2220c4ea0685d580f36811", "rb") as data:
        ...
        if HAVE_MACO:
            assert convert_to_MACO(conf).model_dump(exclude_defaults=True, exclude_none=True) == {
                ...
                "http": [
                    {"uri": "https://arsimonopa.com/live/", "usage": "c2"},
                    {"uri": "https://lemonimonakio.com/live/", "usage": "c2"},
                ],
                "encryption": [{"algorithm": "RC4", "key": "12345"}],
            }
