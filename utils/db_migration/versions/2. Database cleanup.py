...
def upgrade() -> None:
    ...
    op.alter_column("samples", "file_size", existing_type=sa.INTEGER(), type_=sa.BIGINT(), existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column("samples", "file_size", existing_type=sa.BIGINT(), type_=sa.INTEGER(), existing_nullable=False)
