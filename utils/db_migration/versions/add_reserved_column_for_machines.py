...
def upgrade():
    ...
    op.add_column("machines", sa.Column("reserved", sa.Boolean(), nullable=False))
    op.create_unique_constraint(None, "machines", ["label"])
    op.create_unique_constraint(None, "machines", ["name"])
